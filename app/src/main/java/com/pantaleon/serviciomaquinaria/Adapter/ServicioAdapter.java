...
public class ServicioAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {

    public List<Servicio> info;
    List<Servicio> aux;
    ...
    public ServicioAdapter(List<Servicio> info, Context context, OnItemClickListener mItemClickListener) {
        this.info = info;
    ...
    public void setInfo(List<Servicio> info) {
        this.info = info;
        this.aux = new ArrayList<>(info);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View tarjeta = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_servicio, parent, false);
    ...
    public class ItemAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        public TextView lblCVDescripcion,lblCVTotalRegistros,lblCVVerDetalle;
        public CardView cv;
        public ImageView imgvwFondoCV;

        public ItemAdapterViewHolder(View itemView) {
            super(itemView);

            lblCVDescripcion = (TextView) itemView.findViewById(R.id.lblCVDescripcion);
            lblCVTotalRegistros = (TextView) itemView.findViewById(R.id.lblCVTotalRegistros);
            lblCVVerDetalle = (TextView) itemView.findViewById(R.id.lblCVVerDetalle);
            imgvwFondoCV = (ImageView) itemView.findViewById(R.id.imgvwFondoCV);
            lblCVVerDetalle.setOnClickListener(this);
